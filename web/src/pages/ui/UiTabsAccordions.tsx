                    ...
                    {accordionItems.slice(0, 3).map((item, i) => (
                        <div key={i} className="hud-card hud-card-bottom rounded-lg overflow-hidden">
                            ...
                            >
                                ...
                                <div className={`w-6 h-6 rounded flex items-center justify-center transition-hud ${openAccordions.includes(i + 10) ? 'bg-hud-accent-primary text-hud-onAccent' : 'bg-hud-bg-primary text-hud-text-muted'
                                    }`}>
