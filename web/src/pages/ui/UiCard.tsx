        ...
        <div className="space-y-6 animate-fade-in">
                    ...
                    <div className="hud-card hud-card-bottom rounded-lg overflow-hidden group">
                        <div className="relative h-40 bg-gradient-to-br from-hud-accent-info/30 to-hud-accent-primary/30 flex items-center justify-center">
                            ...
                            <div className="absolute inset-0 bg-hud-bg-primary/80 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                                <button className="p-2 bg-hud-accent-primary text-hud-onAccent rounded-full"><Heart size={16} /></button>
                                <button className="p-2 bg-hud-accent-primary text-hud-onAccent rounded-full"><ExternalLink size={16} /></button>
                            </div>
                        </div>
                        <div className="p-4">
            ...
            <HudCard title="Colored Cards" subtitle="Cards with accent colors">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                        { color: 'from-hud-accent-primary to-hud-accent-info', label: 'Primary' },
                        { color: 'from-hud-accent-secondary to-hud-accent-warning', label: 'Secondary' },
                        { color: 'from-hud-accent-success to-hud-accent-primary', label: 'Success' },
                        { color: 'from-hud-accent-warning to-hud-accent-danger', label: 'Warning' },
                    ].map((item) => (
                        <div
                            key={item.label}
                            className={`rounded-lg p-5 bg-gradient-to-br ${item.color} text-hud-onAccent`}
                        >
